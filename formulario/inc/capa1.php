<title>FormMKC 2.0 Beta  -  Hecho Por Datux.cl</title>
<script>
    ...
    function llamar()
    {
        ...
        document.location.href = "sip:" + telefono_gestion + "@192.168.20.59"
...
while ($rowx = mysql_fetch_array($resultx)) {
    ...
    $ofe1 = $rowx['oferta1'];
    $saldo_cuota = $rowx['saldo_cuota'];
    $valor_cuota = $rowx['valor_cuota'];
    $provision_credi = $rowx['provision_credito'];
...
<fieldset class='field'>
    ...
    <form name="form1" action='#' method="GET">
        <?php
        $hoy = date('d-m-Y');
        $no_pasar_max = date("Y/m/d", strtotime("$hoy + 60 days"));
        ...
        <table border='1' width='1050'cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
            ...
            <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>
                ...
                <td width=''><font face="verdana,arial" size=1 >NUMERO DE CUENTA</td>
    ...
    if (mysql_num_rows($result) != 0) {
        ...
        <table border='1' width='1050'cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
            <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='20'>
                <td width='10'><font face="verdana,arial" size=1>N�</td>
                <td width='100'><font face="verdana,arial" size=1 >CAMPA�A</td>
...
$calc_categoria = $connect->consulta("SELECT * from sistema_subcategorias,sistema_subcategorias_asociacion where campaign = '$_GET[campaign]' and sistema_subcategorias_asociacion.id_categoria = sistema_subcategorias.id_categoria");
while ($row3 = mysql_fetch_array($calc_categoria)) {
    $subcategoria = $row3["categoria"];
}
...
if ($cedente == 'ABCDIN') {
    ...
    if ($subcategoria != 'CONVENIOS') {
        ?>
        <fieldset class='field'>
            <legend ><font face="verdana,arial" size=1><b> DEUDA CLIENTE ABCDIN NORMAL</b></font></legend>
            <?php
            ...
            <table border='1' width='850' cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
                ...
                <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>
                    ...
                    <td width='135'><font face="verdana,arial" size=1 >OTR. CARGOS</td>
                    <td width='185'><font face="verdana,arial" size=1 >TOT CONVENIO</td>
                ...
                <tr  bgcolor="white" onMouseover="this.style.backgroundColor = '#DDF'" onMouseout="this.style.backgroundColor = 'white'">
                    ...
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $oferta2; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
        ...
        ?>
        <fieldset class='field'>
            <legend ><font face="verdana,arial" size=1><b> DEUDA CLIENTE ABCDIN CONVENIOS</b></font></legend>
            <?php
            $result = $connect->consulta("SELECT * from sistema_gestiones  where rut_cliente = '$_GET[vendor_id]' order by fecha desc");
            $cant_gestion = mysql_num_rows($result);
            $result = $connect->consulta("SELECT fecha from sistema_gestiones where rut_cliente = '$_GET[vendor_id]' order by fecha desc limit 1");
            ...
            <table border='1' width='900' cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
                ...
                <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>
                    ...
                    <td width='145'><font face="verdana,arial" size=1>MONTO CONVENIO 1</td>
                    <td width='145'><font face="verdana,arial" size=1>FECHA VENC CONVENIO 1</td>
                    <td width='145'><font face="verdana,arial" size=1>FECHA VENC CONVENIO 2</td>
                    <td width='145'><font face="verdana,arial" size=1>MONTO CONVENIO 2</td>
                    <td width='145'><font face="verdana,arial" size=1>FECHA VENC CONVENIO 3</td>
                    <td width='145'><font face="verdana,arial" size=1>MONTO CONVENIO 3</td>

                </tr>
                <tr  bgcolor="white" onMouseover="this.style.backgroundColor = '#DDF'" onMouseout="this.style.backgroundColor = 'white'">

                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $codpro; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value=' <?php echo $ofe1; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $adicional1; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $oferta2; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $adicional2; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $adicional3; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                </tr>
                <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>


                    <td width='145'><font face="verdana,arial" size=1>DIAS MORA</td>
                    <td width='145'><font face="verdana,arial" size=1>SALDO CONVENIO</td>
                    <td width='145'><font face="verdana,arial" size=1>NUMERO CUOTAS CONVE</td>
                    <td width='145'><font face="verdana,arial" size=1>TOTAL PAGOS CONV</td>
                    <td width='145'><font face="verdana,arial" size=1>GENERACION CONV</td>

                </tr>
                <tr  bgcolor="white" onMouseover="this.style.backgroundColor = '#DDF'" onMouseout="this.style.backgroundColor = 'white'">

                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $dias_mora; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value=' <?php echo $abono; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $cartera; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $saldo_cuota; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                    <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $provision_credi; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                </tr>
            </table>
            ...
            <table border='1' width='900' cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
                ...
                <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>
                    ...
                    <td width='145'><font face="verdana,arial" size=1 >TOTAL DEUDA</td>
                    <td width='200'><font face="verdana,arial" size=1 >MONTO TOTAL PROM. PAGO   </td>
                    <td width='100'><font face="verdana,arial" size=1 >GESTIONES</td>
                    <td width='170'><font face="verdana,arial" size=1 >FECHA COMP. PAGO</td>
                    <td width='145'><font face="verdana,arial" size=1 >$ ULT COMPRO</td>
                    <td width='165'><font face="verdana,arial" size=1 >FECHA ULT GESTION</td>
                    <td width='145'><font face="verdana,arial" size=1 >DEU X VENCER</td>
...
if ($cedente == 'TRICOT') {
    ?>
    <fieldset class='field'>
        <legend ><font face="verdana,arial" size=1><b> DEUDA CLIENTE TRICOT</b></font></legend>
        <?php
        $result = $connect->consulta("SELECT * from sistema_gestiones  where rut_cliente = '$_GET[vendor_id]' order by fecha desc");
        $cant_gestion = mysql_num_rows($result);
        $result = $connect->consulta("SELECT fecha from sistema_gestiones where rut_cliente = '$_GET[vendor_id]' order by fecha desc limit 1");
        ...
        $time = strtotime($fec_venc);
        $ano = date('Y', $time);
//// A�OS DESCUENTOS
        if ($ano <= '2006') {
            $desc_capital = ($monto / 100) * 60;
            $desc_otros = ($deuda_total / 100) * 100;
            $desc_capital_c = ($monto / 100) * 50;
            $desc_otros_c = ($deuda_total / 100) * 100;
            $desc_k = '60';
            $desc_o = '100';
        }
        if ($ano == '2007') {
        ...
        if ($ano == '2010') {
            $desc_capital = ($monto / 100) * 60;
            $desc_otros = ($deuda_total / 100) * 85;
            $desc_capital_c = ($monto / 100) * 60;
            $desc_otros_c = ($deuda_total / 100) * 85;
            $desc_k = '60';
            $desc_o = '85';
        }
        if ($ano == '2011') {
            $desc_capital = ($monto / 100) * 50;
            $desc_otros = ($deuda_total / 100) * 85;
            $desc_capital_c = ($monto / 100) * 30;
            $desc_otros_c = ($deuda_total / 100) * 85;
            $desc_k = '50';
            $desc_o = '85';
        }
        if ($ano == '2012') {
            $desc_capital = ($monto / 100) * 40;
            $desc_otros = ($deuda_total / 100) * 80;
            $desc_capital_c = ($monto / 100) * 30;
            $desc_otros_c = ($deuda_total / 100) * 80;
            $desc_k = '40';
            $desc_o = '80';
        }
        if ($ano == '2013') {
            $desc_capital = ($monto / 100) * 20;
            $desc_otros = ($deuda_total / 100) * 80;
            $desc_capital_c = ($monto / 100) * 15;
            $desc_otros_c = ($deuda_total / 100) * 80;
            $desc_k = '20';
            $desc_o = '80';
        }
        if ($ano == '2014') {
            $desc_capital = ($monto / 100) * 15;
            $desc_otros = ($deuda_total / 100) * 70;
            $desc_capital_c = ($monto / 100) * 10;
            $desc_otros_c = ($deuda_total / 100) * 70;
            $desc_k = '15';
            $desc_o = '70';
        }
        if ($ano == '2015') {
        ...
        $total_pagar = number_format(($monto - $desc_capital) + ($deuda_total - $desc_otros));
        $total_pagar_c = number_format(($monto - $desc_capital_c) + ($deuda_total - $desc_otros_c));
        ?>
        ...
        <table border='1' width='850' cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
            ...
            <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>
                ...
                <td width='145'><font face="verdana,arial" size=1>CAPITAL</td>
                <td width='145'><font face="verdana,arial" size=1>OTROS</td>
                <td width='145'><font face="verdana,arial" size=1>DEUDA TOTAL</td>
                <td width='145'><font face="verdana,arial" size=1 >FECHA VENC.</td>
                <td width='120'><font face="verdana,arial" size=1 >A�O VENC.</td>
                <td width='135'><font face="verdana,arial" size=1 >DESC CAPITAL</td>
                <td width='185'><font face="verdana,arial" size=1 >DESC OTROS</td>
                <td width='185'><font face="verdana,arial" size=1 >TOTAL PAGAR</td>
                <td width='185'><font face="verdana,arial" size=1 >PAGAR CONVENIO</td>
            ...
            <tr  bgcolor="white" onMouseover="this.style.backgroundColor = '#DDF'" onMouseout="this.style.backgroundColor = 'white'">
                ...
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo number_format($deuda_total, 0); ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo number_format($monto + $deuda_total, 0); ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $fec_venc; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $ano; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo number_format($desc_capital, 0) . " (" . $desc_k . "%)"; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo number_format($desc_otros, 0) . " (" . $desc_o . "%)"; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $total_pagar; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $total_pagar_c; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
            </tr>
        </table>
...
if ($cedente == 'CORONA') {
    ?>
    <fieldset class='field'>
        <legend ><font face="verdana,arial" size=1><b> DEUDA CLIENTE CORONA</b></font></legend>
        <?php
        $result = $connect->consulta("SELECT * from sistema_gestiones  where rut_cliente = '$_GET[vendor_id]' order by fecha desc");
        $cant_gestion = mysql_num_rows($result);
        $result = $connect->consulta("SELECT fecha from sistema_gestiones where rut_cliente = '$_GET[vendor_id]' order by fecha desc limit 1");
        ...
        <table border='1' width='850' cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
            ...
            <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>
                ...
                <td width='145'><font face="verdana,arial" size=1>DIAS MORA</td>
                <td width='145'><font face="verdana,arial" size=1>INTERES MOROS.</td>
                <td width='145'><font face="verdana,arial" size=1 >GASTOS MOROS.</td>
                <td width='145'><font face="verdana,arial" size=1 >DEUDA TOTAL</td>
                <td width='145'><font face="verdana,arial" size=1 >DIAS ATRASO HOY</td>
                <td width='165'><font face="verdana,arial" size=1 >FECHA ULT.PAGO</td>
                <td width='185'><font face="verdana,arial" size=1 >REPACTADO</td>


            </tr>
            <tr  bgcolor="white" onMouseover="this.style.backgroundColor = '#DDF'" onMouseout="this.style.backgroundColor = 'white'">

                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $fecha_abono; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo number_format($cuotas_vencidas, 0); ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo number_format($deuda_total, 0); ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo number_format($monto, 0); ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $fecha_abono; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
                <td height="19"><font face="verdana,arial" color='white'  ><input type='text' value='<?php echo $fec_venc; ?>' style="width:100%"  name='nom_rep_legal'    class='tb10' onKeypress="return solo_numeros(event);"  onBlur="validar1(this.form)" ></td>
...
<fieldset class='field'>
    ...
    <table border='1' width='450' cellspacing='1' cellpadding='1' style="border-top-color:WHITE; border-top-width:1px;border-top-style:solid;border-left-color:WHITE; border-left-width:1px;border-left-style:solid;border-collapse: collapse;">
        ...
        <tr  background='../images/ui-bg_gloss-wave_55_5c9ccc_500x100.png' height='16'>
            ...
            <td width='150'><font face="verdana,arial" size=1>F.COMPROMISO</td>
        ...
        <tr bgcolor="white">
            ...
            <td>
                <input name="fecha_compromiso" class='tb10' type="text" value='' id="dateArrival" onClick="popUpCalendar(this, form1.dateArrival, 'yyyy-mm-dd');" style="width:100%" >
            </td>

...
$consulta= "SELECT * from gestiones_tricot";
...
$result = $connect->consulta("SELECT * from gestiones_tricot limit $paginas_botones");
...
function display_data_busca(pagina,cuantas)
{
   ...
   var mostrarOpciones = 'carga_grilla.php?pagina='+pagina+'&cuantas='+cuantas+'&desde='+desde+'&hasta='+hasta;
   $.post(mostrarOpciones, function (responseText){
		$("#grilla").html(responseText);
   });
       $("#num_pagina").attr("disabled",true);  

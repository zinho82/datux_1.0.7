...
<legend ><font face="verdana,arial" size=1><b> CARGA DE REGISTROS</b></font></legend>
 ...
 <tr><td>
<center> <FONT CLASS="main_text"><b>Agregar Registros a la lista (DEUDORES)<?php echo $list_id; ?>, Campaña: <?php echo $_GET[campaign_id]; ?>
		</td></tr>
		</table>
	<br>
	<table border="0" cellspacing="0" align="center" width="95%">
...
<form enctype="multipart/form-data" method="post" action="importar.php" name="uploadform">

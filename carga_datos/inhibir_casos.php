...
<fieldset>
<legend ><font face="verdana,arial" size=1><b> BAJA DE REGISTROS</b></font></legend>
...
?>
 ...
 <tr><td>
<center> <FONT CLASS="main_text"><b>Inhibir Registros a la lista <?php echo $list_id; ?>, Campaña: <?php echo $campaign_id; ?>
		</td></tr>
		</table>
	<br>
	<table border="0" cellspacing="0" align="center" width="95%">
...
<form enctype="multipart/form-data" method="post" action="inhibir.php" name="uploadform">

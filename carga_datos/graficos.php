...
<fieldset>
<legend ><font face="verdana,arial" size=1><b> GRAFICOS - RENDIMIENTO CAMPA�AS</b></font></legend>	 
 
<table border='0' cellspacing=0 cellpading=0>
<tr><td width=820 valign="top">
<iframe src ="grafico1.php?campaign_id=<?php echo $campaign_id;?>" width=830 height="350"  scrolling="no" frameborder="0">
  <p>Your browser does not support iframes.</p>
</iframe>
</td>
<td>
<iframe src ="grafico2.php?campaign_id=<?php echo $campaign_id;?>" width="420" height="360" scrolling="no" frameborder="0">
  <p>Your browser does not support iframes.</p>
</iframe>
</td>
</tr>

...
<fieldset>
<legend ><font face="verdana,arial" size=1><b> CARGA DE REGISTROS</b></font></legend>

 <table border="0" cellspacing="0" align="center" width="95%">
 <tr><td>
<center> <FONT CLASS="main_text"><b>Agregar Registros a la lista <?php echo $list_id; ?>, Campaña: <?php echo $_GET[campaign_id]; ?>
		</td></tr>
		</table>
	<br>
	<table border="0" cellspacing="0" align="center" width="95%">
...
<center> <FONT CLASS="main_text"><b>Importar desde planilla CVS 
		...
		<tr><td>
		<center><br><font class="main_text_c">Seleccione su archivo CVS<br><br>
<form enctype="multipart/form-data" method="post" action="importar_ubicabilidad.php" name="uploadform">

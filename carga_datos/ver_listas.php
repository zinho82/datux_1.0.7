...
<tr>
<td width="150"  bgcolor="DADAd5"><font class="main_text_c"><center>NOMBRES DEUDORES</td>
<td width="150"  bgcolor="DADAd5"><font class="main_text_c"><center>INFORMACION DEUDA</td>
</tr><tr onMouseover="this.style.backgroundColor='#81BEF7'" onMouseout="this.style.backgroundColor='#CEE3F6'" bgcolor='#CEE3F6'>
<td width="150" align="center">
<button type="button"   onClick="top.frames['mainFrame'].location.href = 'ingreso_listas.php?list_id=<?php echo $row["list_id"]; ?>&campaign_id=<?php echo $campaign_id; ?>&cod_cedente=<?php echo $cod_cedente; ?>'"> <font class="main_text">INGRESAR<br>
<img src="../images/Crystal_Clear_app_kontact.png" width='45' height='10'></td>


<td width="150" align="center">
<button type="button"   onClick="top.frames['mainFrame'].location.href = 'ingreso_deudas.php?list_id=<?php echo $row["list_id"]; ?>&campaign_id=<?php echo $campaign_id; ?>&cod_cedente=<?php echo $cod_cedente; ?>'"> <font class="main_text">INGRESAR<br>
<img src="../images/Crystal_Clear_app_kontact.png" width='45' height='10'></td>

</tr>
<td width="20" align="center"><a href="vaciado_nombres.php?list_id=<?php echo $row["list_id"]; ?>&campaign_id=<?php echo $campaign_id; ?>" onclick="return confirmar('¿Está seguro que desea vaciar los registros de nombres?')" title="Vaciar registros de nombres"><img src="../images/icons/basket_delete.png" border="0"></a></td>
<td width="20" align="center"><a href="vaciado_deudas.php?list_id=<?php echo $row["list_id"]; ?>&campaign_id=<?php echo $campaign_id; ?>" onclick="return confirmar('¿Está seguro que desea vaciar los registros de deuda?')" title="Vaciar registros de deudas"><img src="../images/icons/basket_delete.png" border="0"></a></td>
...
<td width="20" align="center"><a href="ingreso_ubicabilidad.php?list_id=<?php echo $row["list_id"]; ?>&campaign_id=<?php echo $campaign_id; ?>" title="Añadir datos de ubicabilidad"><img src="../images/icons/application_add.png" border="0"></a></td>


 <td width="20" align="center"><a href="vaciado_listas.php?list_id=<?php echo $row["list_id"]; ?>&campaign_id=<?php echo $campaign_id; ?>" onclick="return confirmar('¿Está seguro que desea vaciar la lista?')" title="Vaciar registros de lista"><img src="../images/icons/basket_delete.png" border="0"></a></td>

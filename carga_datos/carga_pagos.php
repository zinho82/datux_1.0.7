...
<fieldset>
<legend ><font face="verdana,arial" size=1><b> CARGA DE PAGOS</b></font></legend>

 <table border="0" cellspacing="0" align="center" width="95%">
 <tr><td>
<center> <FONT CLASS="main_text"><b>Cargar pagos a Campaña: <?php echo $_GET[campaign_id]; ?>
		</td></tr>
		</table>
	<br>
	<table border="0" cellspacing="0" align="center" width="95%">
...
<form enctype="multipart/form-data" method="post" action="importar_pagos.php" name="uploadform">

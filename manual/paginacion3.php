...
<tr>
   <td><?php echo "USUARIO: ".$_SESSION['user']." NOMBRE: "."<font size='2' color='RED'><b>".$_SESSION['full_name']."</b></font> CAMPAÑA: <font size='2' color='RED'><b>".$_SESSION['campaign_id']."</font>";?></td>
</tr>
</table>

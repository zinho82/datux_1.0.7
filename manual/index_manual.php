...
$campaigns = $connect->consulta("SELECT * FROM vicidial_campaigns where active = 'Y'");
	...
	<fieldset class="swiftfieldset">
            ...
            <tr class="tcat">
					  ...
					  <tr>
						...
						<form name="loginform" action="autentificar_manual.php" method="post"><table border="0" cellpadding="2" cellspacing="1" width="100%">
						  <tbody><tr>

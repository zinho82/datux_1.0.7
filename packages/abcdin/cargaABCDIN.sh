...
INTO OUTFILE '/var/www/html/sistema_gestion/archivos/cargar/ABCDIN_carga_deudores_${FECHA}.csv'
...
INTO OUTFILE '/var/www/html/sistema_gestion/archivos/cargar/ABCDIN_carga_deuda_${FECHA}.csv'
FIELDS TERMINATED BY ';'
ENCLOSED BY ''
LINES TERMINATED BY '\n'
"
...
INTO OUTFILE '/var/www/html/sistema_gestion/archivos/cargar/ABCDIN_carga_UBICABILIDAD_${FECHA}.csv'
FIELDS TERMINATED BY ';'
ENCLOSED BY ''
LINES TERMINATED BY '\n'"
...
tar  cvf ABCDIN_carga_${FECHA}.tar ABCDIN_carga_*${FECHA}.csv

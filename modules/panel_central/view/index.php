<?php
 require_once '../../plantilla/Superior.php';
   session_start();  
 ...
 */
 ...
 {
 ?>
 <td width="20" align="center"><a href='carga_datos/campaign.php?opcion=eliminar&campaign_id=<?php echo $campaign_id; ?>' onclick="return confirmar('�Est� seguro que desea eliminar el registro?')"><img src="images/icons/delete.png" border="0"></a></td>
 <?php/*
 }
 else 
 ...
 <td width="20" align="center"><a href="carga_datos/ver_listas.php?campaign_id=<?php //echo $row["campaign_id"]; ?>" title="Inhibir registros de campa�a"><img src="images/icons/application_delete.png" border="0"></a></td>
